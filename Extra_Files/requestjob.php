...
?>
   <head>
     ...
     function requestfun(e){
        ...
        $.ajax({url:"./help_modules/resultrow.php",type:"post",method:"post",data:{qry:"insert into requestjob(`postid`, `requestid`, `message`, `mobile`,`resid`) values("+e.postid+","+<?php  echo $_GET["requestpostid"];?>+",'"+conversation+"',"+mobile+","+localStorage.getItem("Temp_ID")+")"},beforeSend:function(){
